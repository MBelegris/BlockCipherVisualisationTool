...
# plaintext = hex(0x3243f6a8885a308d313198a2e0370734)
# key_1 = hex(0x2b7e151628aed2a6abf7158809cf4f3c)
# key_2 = hex(0xa0fafe1788542cb123a339392a6c7605)
plaintext = hex(random.randint(0, 340282366920938463463374607431768211455))
key_1 = hex(random.randint(0, 340282366920938463463374607431768211455))
key_2 = hex(random.randint(0, 340282366920938463463374607431768211455))
...
ciphertext = do_encrypt(plaintext, key_1, key_2)

print("----------------------------------------")

plaintext = do_decrypt(ciphertext, key_1, key_2)
print("----------------------------------------")
